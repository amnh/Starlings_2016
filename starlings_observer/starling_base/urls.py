...
"""
	url(r'^add_death/add_collection$', views.add_collection, name='add_collection'),
	url(r'^add_collection/add_identifiers$', views.add_identifiers, name='add_identifiers'),
	url(r'^add_identifiers/add_complex_traits$', views.add_complex_traits, name='add_complex_traits'),
	url(r'^add_complex_traits/add_preparation$', views.add_preparation, name='add_preparation'),
	url(r'^add_preparation/add_location$', views.add_location, name='add_location'),
