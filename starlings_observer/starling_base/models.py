...
class BasicTraits(models.Model):
    ...
    basic_traits_id = models.TextField(db_column='Basic_Traits_ID', blank=True, null=True, primary_key=True)  # Field name made lowercase. This field type is a guess.
...
class Collection(models.Model):
    ...
    collection_id = models.TextField(db_column='Collection_ID', blank=True, null=True, primary_key=True)  # Field name made lowercase. This field type is a guess.
...
class ComplexTraits(models.Model):
    weight_g_field = models.DecimalField(db_column='WEIGHT_(g)', blank=True, null=True, max_digits=None, decimal_places=None)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
...
class Death(models.Model):
    ...
    death_id = models.TextField(db_column='Death_ID', blank=True, null=True, primary_key=True)  # Field name made lowercase. This field type is a guess.
...
class Identifiers(models.Model):
    ...
    identifiers_id = models.TextField(db_column='Identifiers_ID', blank=True, null=True, primary_key=True)  # Field name made lowercase. This field type is a guess.
