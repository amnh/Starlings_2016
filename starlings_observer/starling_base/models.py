...
class BasicTraits(models.Model):
    ...
    basic_traits_id = models.TextField(db_column='Basic_Traits_ID', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
...
class BirdInfo(models.Model):
    ...
    complex_traits_id = models.ForeignKey(db_column='Complex_Traits_ID', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
    location_id = models.TextField(db_column='Location_ID', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
    preparation_id = models.TextField(blank=True, null=True)  # This field type is a guess.
    pre_skin_id = models.TextField(db_column='Pre_Skin_ID', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
    skin_id = models.TextField(db_column='Skin_ID', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
...
class Collection(models.Model):
    ...
    collection_id = models.TextField(db_column='Collection_ID', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
...
class ComplexTraits(models.Model):
    weight_g_field = models.TextField(db_column='WEIGHT_(g)', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    ...
    basic_traits_id = models.TextField(db_column='Basic_Traits_ID', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
    complex_traits_id = models.TextField(db_column='Complex_Traits_ID', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
...
class Death(models.Model):
    ...
    death_id = models.TextField(db_column='Death_ID', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
...
class Identifiers(models.Model):
    ...
    identifiers_id = models.TextField(db_column='Identifiers_ID', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
...
class Preparation(models.Model):
    ...
    death_id = models.TextField(db_column='Death_ID', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
    preparation_id = models.TextField(db_column='Preparation_ID', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
